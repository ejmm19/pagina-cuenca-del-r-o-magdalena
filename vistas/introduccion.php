...
<html lang="en" class="no-js">
	<head>
		...
		.limpiar{
			...
			#escalar1:hover{
				-webkit-transform: scale(4, 5)translate(1px, 30px);
  				-moz-transform: scale(4, 5)translate(1px, 30px);
  				-o-transform: scale(4, 5)translate(1px, 30px);
  				-ms-transform: scale(4, 5)translate(1px, 30px);
  				transform: scale(4, 5)translate(1px, 30px);
  			}
			...
			#escalar:hover{
				-webkit-transform: scale(4, 5)translate(80px, 10px);
  				-moz-transform: scale(4, 5)translate(80px, 10px);
  				-o-transform: scale(4, 5)translate(80px, 10px);
  				-ms-transform: scale(4, 5)translate(80px, 10px);
  				transform: scale(4, 5)translate(80px, 10px);
			}
			#escal{
				-webkit-transition: all 1s ease-in-out;
    			-moz-transition: all 1s ease-in-out;
			...
			#escal:hover{
				-webkit-transform: scale(4, 5)translate(10px, 10px);
  				-moz-transform: scale(4, 5)translate(10px, 10px);
  				-o-transform: scale(4, 5)translate(10px, 10px);
  				-ms-transform: scale(4, 5)translate(10px, 10px);
  				transform: scale(4, 5)translate(10px, 10px);
			}
			#escala{
				-webkit-transition: all 1s ease-in-out;
    			-moz-transition: all 1s ease-in-out;
	...
	<body>
		<div class="container">
			...
			<div id="theSidebar" class="sidebar">
					...
					<a  href="../index.php#titulo" ><span>Atras</span></a>
					
			
				<h1><span>Introducción<span><br><br><br><img src="../img/otherapps/placeholder_one.png" width="60%"></h1>
			...
			<div id="theGrid" class="main">
				<section class="grid">
					<header class="top-bar">
						<h2 class="top-bar__headline">Selecciona uno de los Temas</h2>
						
					</header>
					<a class="grid__item" href="#">
						<h2 class="title title--preview">Introducción</h2>
						<center><img src="../img/iconos/send4.png" width="10%"></center>
					...
					<a class="grid__item" href="#">
						<h2 class="title title--preview">¿Qué es una cuenca hidrográfica?</h2>
						<center><img src="../img/iconos/think7.png" width="15%"></center>
						<div class="loader"></div>
					...
					<a class="grid__item" href="#">
						<h2 class="title title--preview">La Cuenca Hidrográfica del río Magdalena</h2>
						<center><img src="../img/iconos/river3.png" width="10%"></center>
						<div class="loader"></div>
					...
					<a class="grid__item" href="#">
						<h2 class="title title--preview">Cuenca Alta</h2>
						<center><img src="../img/iconos/black397.png" width="10%"></center>
						<h4>(Video)</h4>
						<div class="loader"></div>
					...
					<a class="grid__item" href="#">
						<h2 class="title title--preview">Cuenca Media</h2>
						<center><img src="../img/iconos/black397.png" width="10%"></center>
						<h4>(Video)</h4>
						<div class="loader"></div>
					...
					<a class="grid__item" href="#">
						<h2 class="title title--preview">Cuenca Baja</h2>
						<center><img src="../img/iconos/black397.png" width="10%"></center>
						<h4>(Video)</h4>
						<div class="loader"></div>
				...
				<section class="content">
					<div class="scroll-wrap">
						...
						<article class="content__item">
							...
							<h2 class="title title--full">Introducción</h2>
							<div class="meta meta--full">
								
								
								<span class="meta__date"></span>
								<span class="meta__reading-time"></span>
							</div>
							<p></p>
							<p>El Programa de Geografía de la Universidad de Córdoba, en su objetivo de enseñar y proyectar la geografía en el entorno regional del Caribe colombiano y del resto del país, ha diseñado una serie de aplicativos pedagógicos e interactivos con el fin de mostrar de forma didáctica ciertos temas de estudio de la ciencia geográfica.</p>
							<p>El siguiente aplicativo es fruto del trabajo de clases realizado en la Electiva de Carrera “Ordenamiento de cuencas hidrográficas” la cual está enmarcada dentro de la línea de investigación “Organización espacial y prospectiva territorial”, liderada por los docentes Rubén Darío Godoy y Rosana Garnica. El tema a tratar es la geografía de la cuenca hidrográfica del río Magdalena. Para aprender los aspectos geográficos de la cuenca, teniendo en cuenta los siguientes aspectos: generalidades, aspectos físicos, económicos, sociales y proyectos a futuro en la cuenca. Esto ayudará a ampliar el conocimiento de cualquier persona interesada en aprender un poco más sobre las principales características de este río, el más importante de Colombia.</p>
							
						</article>
						<article class="content__item">
							
							<h2 class="title title--full">¿Qué es una cuenca hidrográfica?</h2>
							<div class="meta meta--full">
								
								
							</div>
							<p></p>
							<p>Con base al decreto 1729 de 2002, una cuenca hidrográfica puede definirse como un área en donde todos los cursos de agua fluyen hacia una red principal, la cual está delimitada por montañas y en sus partes más bajas, se encuentra un valle que ha sido moldeado por la acción erosiva del río principal. </p>
							<br><br>
							<center><div class="rectangulo" id="escalar1">
										<img src="../img/cuenca.jpg" width="100%;">
										 </div>
										<div class="limpiar"> </div>
							<div class="limpiar"> </div></center>
							<p>Las cuencas son lugares de gran riqueza ambiental porque son fuentes importantes de agua, además albergan flora, fauna y otros recursos naturales que benefician al ser humano y ayudan a mantener el equilibrio ecológico, por eso deben cuidarse y ordenarse para garantizar su uso sostenible. La cuenca también es unidad social, política, económica y ecológica, que juega un papel fundamental en el aseguramiento de la seguridad alimentaria, económica y social, y además provee servicios que garantizan el bienestar de la población rural y urbana (Wani et al, 2008).</p>
						</article>
						<article class="content__item">
							<span class="category category--full"></span>
							<h2 class="title title--full">La Cuenca Hidrográfica del Río Magdalena</h2>
							<div class="meta meta--full">
							</div>
							<p></p>
							
							<p>El río Magdalena es el río más importante de Colombia, tiene una longitud de 1.550 Kilómetros. Nace a 3.600 metros sobre el nivel del mar en el Macizo Colombiano y desemboca al Mar Caribe en Bocas de Ceniza en el departamento del Atlántico.</p>

							<p>La cuenca del Magdalena presenta una extensión de 196.757,9 Km2, lo que representa el 17% del territorio colombiano, y se considera que la longitud navegable del río es estimada en 886 Kilómetros (CORMAGDALENA, 2007).La cuenca se encuentra sectorizada en cuenca alta, media y baja. Los criterios de división son principalmente las formas del relieve y las características del río en las distintas partes de la cuenca.</p>
							
							<center>
								<section class="grid">
								<div class="rectangulo" id="escalar">
										<img src="../img/mag.jpg" width="100%;">
										 </div>
							<div class="limpiar"></div>			 
							<div class="limpiar"></div>
							

							<div class="rectangulo2"  id="escal">
										<img src="../img/subcuencas_magdalena.jpg" width="100%;">
										 </div>
							<div class="limpiar"></div>			 
							<div class="limpiar"></div>
							
							
							<div class="rectangulo3" id="escala">
										<img src="../img/departametos_cuenca_magdalena.jpg" width="100%;">
										 </div>
							<div class="limpiar"></div>			 
							<div class="limpiar"></div>
								</section>
							...
							<p>La cuenca del río Magdalena cuenta con 13 departamentos, los cuales en total suman 596 municipios, de ellos 128 son ribereños del río Magdalena</p>

							
						</article>
						<article class="content__item">
							<span class="category category--full">Cuenca Alta</span>
							...
							<center>
							<div>
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12541.734137175139!2d-74.71977326690588!3d8.
							703837997138729!2m3!1f0!2f78.39705454044145!3f0!3m2!1i1024!2i768!4f20!3m3!1m2!1s0x8e5eb960fd5ae487%3A0x79857f5
							84af47161!2zUsOtbyBNYWdkYWxlbmEsIE1vbXDDs3MsIEJvbMOtdmFyLCBDb2xvbWJpYQ!5e1!3m2!1ses-419!2sit!4v1447044279776"
